export default [
	'<em>Pelé</em> ganhou cinco vezes o título de melhor jogador do mundo. <em>Ele</em> é o maior artilheiro da história da Seleção Brasileira.',
	'<em>Mark</em> Lamarr inventou um sistema de comunicações para torpedos controlados por rádio. Essa foi a base para outras tecnologias, do Wi-Fi a GPS.',
